/****************************************************************************
** Meta object code from reading C++ file 'ReplaceDialog.hh'
**
...
#include "../inc/Interface/ReplaceDialog.hh"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'ReplaceDialog.hh' doesn't include <QObject>."
...
const QMetaObject ReplaceDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ReplaceDialog.data,
      qt_meta_data_ReplaceDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
